 ...
 * @property {string} photoUrl      - The analyzed photo URL (normalized)
 * @property {string} roomId        - Associated room ID
 * @property {string} listingId     - Parent listing ID
 * @property {number} estimatedSqft - Estimated visible floor area in sqft
 * @property {number} confidence    - 0-1 confidence score
 * @property {number} timestamp     - Epoch ms when scan was performed
 * @property {string} pipeline      - "single" | "multi"
 * @property {string} apiVersion    - Version string of the estimation API
 */

 ...
 *
 * Output:
 *   selfhost/extension/data/nta-boundaries.json - NTA polygon boundaries for point-in-polygon lookup
 *   selfhost/extension/data/crime-stats.json - Precomputed crime statistics per NTA
 */
...
const CONFIG = {
  ...
  // Output paths
  OUTPUT_DIR: path.join(__dirname, '..', 'selfhost', 'extension', 'data'),

...
def scene_multiview_floor(
    *,
    ...
    method_name = "dust3r-pose+moge-floor+room-bounds" if impute_room_corners else "dust3r-pose+moge-floor-visible"
...
def run_pipeline(
    ...
    *,
    ...
    if method_key not in {"dust3r-scene", "single-image"}:
...
def main():
    ...
    parser.add_argument(
        "--multiview-method",
        choices=["dust3r-scene", "single-image"],
